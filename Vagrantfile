...
if olddirname != newdirname
    if ARGV[0] != 'halt' && ARGV[0] != 'destroy'
        ...
        print "every tool depends on the private key of the machine, needs to be reconfigured.\n"
    end
else
    ...
    Vagrant.configure(2) do |config|
        ...
        config.vm.provider 'virtualbox' do |v|
            ...
            v.cpus = 1
            v.customize ["modifyvm", :id, "--natdnshostresolver1", "off"] # does problem on osx
            v.customize ["modifyvm", :id, "--natdnsproxy1", "on"] # neeed for linux
